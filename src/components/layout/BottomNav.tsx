...
const NOTCH_R = 36; // bán kính "miệng" notch — chỉnh theo phản hồi thực tế trên máy (2026-08-01 #4), 34 hơi chật, 38 vừa ôm sát nút vừa đủ thở
const NOTCH_DEPTH = 38; // độ lõm sâu — giữ đủ sâu để nửa dưới FAB chìm vào trong
