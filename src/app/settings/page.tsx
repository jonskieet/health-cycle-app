  ...
  return (
    <main className="flex flex-1 flex-col gap-6 px-5 pt-8">
      <div className="flex items-center justify-between">
        <h1 className="font-display text-xl font-semibold tracking-tight text-[var(--ink)]">Cài đặt</h1>
        <button
          type="button"
        ...
        <div className="fixed inset-0 z-30 flex items-end justify-center bg-black/30" onClick={closePinModal}>
          ...
          >
            ...
            <input
              ...
              placeholder="••••"
              className="rounded-2xl border border-black/10 bg-[var(--surface)] px-4 py-3 text-center text-lg font-semibold tracking-[0.5em] text-[var(--ink)] outline-none"
            />
